package com.app.projectcapstone.callback;
...
import com.app.projectcapstone.model.myo.ByteReader;
...
*/
      ...
      if (EMG_0_ID.equals(characteristic.getUuid().toString())) {
       ...
       //  GestureDetectModelManager.getCurrentModel().event(systemTime_ms, emg_data);
         ...
         mHandler.post(new Runnable() {
            ...
            public void run() {
               dataView.setText(callback_msg);
               identifyEmgDataCallback.onReceiveText(emgDataBytes);
   ...
   public interface IdentifyEmgDataCallback {
      void onReceiveText(byte[] emgDataBytes);
   }
}
